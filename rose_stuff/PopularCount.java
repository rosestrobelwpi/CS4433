...
public class PopularCount {
    ...
    public static class PopularReducer extends Reducer<Text,IntWritable,Text,IntWritable> {
        public void reduce(Text key, Iterable<IntWritable> values, Context context) throws IOException, InterruptedException {
            ...
            context.write(key, new IntWritable(sum)); //Output: PersonID, how many friends they have
    ...
    public static class AvgMapper extends Mapper<Object, Text, Text, IntWritable>{
        ...
        protected void setup(Mapper<Object, Text, Text, IntWritable>.Context context) throws IOException, InterruptedException {
            average = context.getConfiguration().getDouble("avgCount", 0.0); //Getting value computed in main/debug so that we can get the global value. avgCount is the key we retrieve the value
        }
...
//        System.exit(job1.waitForCompletion(true) ? 0 : 1);
        ...
        //Need to get global variable counts
        ...
        Job job2 = Job.getInstance(conf, "Average count");
